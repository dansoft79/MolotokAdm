...
uses
  ...
  USelectStatusTypeQCMulti in 'Select\USelectStatusTypeQCMulti.pas' {SelectStatusTypeQCMultiForm},
  ...
  UQualityControl in 'UQualityControl.pas' {BrowseQualityControlForm},
  ...
  USelectOrderList in 'Select\USelectOrderList.pas' {SelectOrderListForm},
  ...
  UGStatusTypeQC in 'Guide\UGStatusTypeQC.pas' {GStatusTypeQCForm},
  UGStatusTypeQCParams in 'Guide\UGStatusTypeQCParams.pas' {GStatusTypeQCParamForm},
  ...
  UGSurvey in 'Guide\UGSurvey.pas' {GSurveyForm},
  UGSurveyAnswerParams in 'Guide\UGSurveyAnswerParams.pas' {GSurveyAnswerParamForm},
  ...
  UQualityControlSurvey in 'UQualityControlSurvey.pas' {QualityControlSurveyForm},
  UGSurveyParams in 'Guide\UGSurveyParams.pas' {GSurveyParamForm},
  UBrowseNotification in 'UBrowseNotification.pas' {BrowseNotificationForm},
  UQualityControlParams in 'UQualityControlParams.pas' {QualityControlParamForm},
