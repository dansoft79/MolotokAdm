object SelectClientForm: TSelectClientForm
  Left = 388
  Top = 259
  ...
  object DBGrid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewPhone: TcxGridDBColumn
        ...
        OnGetDisplayText = TableViewPhoneGetDisplayText
        Width = 183
      end
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
      'select *'
      'from clientview'
      'where Phone like Concat('#39'%'#39', :P, '#39'%'#39') or :P = '#39#39
      'order by Phone, Name, Address')
    Params = <
      item
        DataType = ftUnknown
        Name = 'P'
