object GSearchHintForm: TGSearchHintForm
  Left = 331
  Top = 196
  Action = MainForm.agSearchHint
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewHintText: TcxGridDBColumn
        DataBinding.FieldName = 'HintText'
        Width = 500
      end
    end
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select  *, WorkClassInfo(ID_WorkClass) as WCInfo, UserInfo(ID_As' +
        'sertUser) as AssertUser'
      'from  SearchHint'
      'where (Deleted = :D or :D = 2) and (Active = :A or :A = 2)'
      'order by  WCInfo, HintText')
    Params = <
      item
    ...
    object QueryHintText: TWideStringField
      DisplayLabel = #1058#1077#1082#1089#1090' '#1087#1086#1076#1089#1082#1072#1079#1082#1080
      FieldName = 'HintText'
      Size = 200
    end
  ...
  object qExists: TZQuery
    ...
    SQL.Strings = (
      ...
      'from SearchHint'
        ...
        'where IfNull(ID_WorkClass, 0) = :IDT and HintText = :N and ID <>' +
        ' :IDE'
      'limit 1')
    Params = <
      item
