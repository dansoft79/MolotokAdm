object GUserForm: TGUserForm
  Left = 331
  Top = 196
  Action = MainForm.agUser
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewLogin: TcxGridDBColumn
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select UserInfo(U.ID_AssertUser) as AssertUser, UserROleInfo(U.I' +
        'D_UserRole) as URInfo, U.*'
      'from UserROle UR, User U'
      
        'where U.ID_UserRole = UR.ID and (U.Deleted = :D or :D = 2) and (' +
        'U.Active = :A or :A = 2)'
      'order by '
