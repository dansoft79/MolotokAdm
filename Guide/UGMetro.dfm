object GMetroForm: TGMetroForm
  Left = 331
  Top = 196
  Action = MainForm.agMetro
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select  *, DistrictInfo(ID_District) DInfo, UserInfo(ID_AssertUs' +
        'er) as AssertUser'
      'from  Metro'
  ...
  object qExists: TZQuery
    ...
    SQL.Strings = (
      'select ID'
      'from metro'
      'where Name = :N and ID_District = :D and ID <> :IDE'
      'limit 1')
    Params = <
      item
        DataType = ftUnknown
