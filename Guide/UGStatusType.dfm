object GStatusTypeForm: TGStatusTypeForm
  Left = 331
  Top = 196
  Action = MainForm.agStatusType
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewWorkerSetup: TcxGridDBColumn
        Caption = #1048#1089#1087#1086#1083'. '#1091#1089#1090#1072#1085#1072#1074#1083#1080#1074#1072#1077#1090
        DataBinding.FieldName = 'WorkerSetup'
        RepositoryItem = Datas.EditRepositoryIntCheckBox
        Width = 120
      end
      object TableViewTrimTime: TcxGridDBColumn
        DataBinding.FieldName = 'TrimTime'
        RepositoryItem = Datas.EditRepositoryIntCheckBox
        Width = 120
      end
      object TableViewShowCancelButton: TcxGridDBColumn
        DataBinding.FieldName = 'ShowCancelButton'
        RepositoryItem = Datas.EditRepositoryIntCheckBox
        Width = 120
      end
      object TableViewShowPayButton: TcxGridDBColumn
        DataBinding.FieldName = 'ShowPayButton'
        RepositoryItem = Datas.EditRepositoryIntCheckBox
        Width = 120
      end
      object TableViewShowWarrantyButton: TcxGridDBColumn
        DataBinding.FieldName = 'ShowWarrantyButton'
        RepositoryItem = Datas.EditRepositoryIntCheckBox
        Width = 120
      end
      object TableViewNeedCall: TcxGridDBColumn
        DataBinding.FieldName = 'NeedCall'
        RepositoryItem = Datas.EditRepositoryIntCheckBox
        Width = 120
      end
  ...
  object Query: TZQuery
    ...
    object QueryWorkerVisible: TSmallintField
      DisplayLabel = #1048#1089#1087#1086#1083#1085#1080#1090#1077#1083#1100' '#1074#1080#1076#1080#1090' '#1079#1072#1082#1072#1079
      FieldName = 'WorkerVisible'
    end
    object QueryWorkerSetup: TSmallintField
      DisplayLabel = #1048#1089#1087#1086#1083#1085#1080#1090#1077#1083#1100' '#1091#1089#1090#1072#1085#1072#1074#1083#1080#1074#1072#1077#1090
      FieldName = 'WorkerSetup'
    end
    object QueryTrimTime: TSmallintField
      DisplayLabel = #1057#1086#1082#1088#1072#1097#1072#1090#1100' '#1074#1088#1077#1084#1103
      FieldName = 'TrimTime'
    end
    object QueryShowCancelButton: TSmallintField
      DisplayLabel = #1050#1085#1086#1087#1082#1072' '#1086#1090#1084#1077#1085#1099
      FieldName = 'ShowCancelButton'
    end
    object QueryShowPayButton: TSmallintField
      DisplayLabel = #1050#1085#1086#1087#1082#1072' '#1086#1087#1083#1072#1090#1099
      FieldName = 'ShowPayButton'
    end
    object QueryShowWarrantyButton: TSmallintField
      DisplayLabel = #1050#1085#1086#1087#1082#1072' '#1075#1072#1088#1072#1085#1090#1080#1080
      FieldName = 'ShowWarrantyButton'
    end
  ...
  object qFrom: TZQuery
    ...
    SQL.Strings = (
      ...
      '  FT.*, '
      '  ST.Deleted,'
      '  StatusTypeInfo(FT.ID_StatusTypeFrom) as STInfo  '
      'from '
      '  StatusTypeFromTo FT'
      ' inner join  StatusType ST on'
      
        '    FT.ID_StatusTypeTo = :ID and FT.ID_StatusTypeFrom = ST.ID an' +
        'd'
      '    (ST.Deleted = :D or :D = 2)'
      'order by  STInfo')
    Params = <
    ...
    object qFromID_StatusTypeFrom: TSmallintField
      FieldName = 'ID_StatusTypeFrom'
    end
    object qFromID_StatusTypeTo: TSmallintField
      FieldName = 'ID_StatusTypeTo'
    end
  ...
  object qTo: TZQuery
    ...
    SQL.Strings = (
      'select '
      '  FT.*, '
      '  StatusTypeInfo(FT.ID_StatusTypeTo) as STInfo, '
      '  ST.Deleted'
      'from '
      '  StatusTypeFromTo FT'
      '  inner  join  StatusType ST on'
      
        '    FT.ID_StatusTypeFrom = :ID and FT.ID_StatusTypeTo = ST.ID an' +
        'd'
      '    (ST.Deleted = :D or :D = 2)'
      'order by  STInfo')
    Params = <
  ...
  object qStatusTypeFrom: TZQuery
    ...
    SQL.Strings = (
      'select *'
      'from StatusTypeFromTo'
      'where ID_StatusTypeTo = :ID')
    Params = <
      item
        DataType = ftUnknown
        Name = 'ID'
