object GReasonForm: TGReasonForm
  Left = 331
  Top = 196
  Action = MainForm.agReason
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewCommentRequired: TcxGridDBColumn
        DataBinding.FieldName = 'CommentRequired'
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select  *, UserInfo(ID_AssertUser) as AssertUser, StatusTypeInfo' +
        '(ID_StatusType) as STInfo'
      'from  Reason'
      'where (Deleted = :D or :D = 2) and (Active = :A or :A = 2)'
      'order by  STInfo, Name')
    Params = <
      item
    ...
    object QueryName: TWideStringField
      DisplayLabel = #1058#1077#1082#1089#1090' '#1087#1088#1080#1095#1080#1085#1099
      DisplayWidth = 100
      FieldName = 'Name'
      Size = 100
    end
    ...
    object QueryID_StatusType: TIntegerField
    ...
    object QueryCommentRequired: TSmallintField
      DisplayLabel = #1050#1086#1084#1084#1077#1085#1090#1072#1088#1080#1081' '#1086#1073#1103#1079#1072#1090#1077#1083#1077#1085
      FieldName = 'CommentRequired'
      ReadOnly = True
    end
  end
