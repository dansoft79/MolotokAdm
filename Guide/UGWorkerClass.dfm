object GWorkerClassForm: TGWorkerClassForm
  Left = 331
  Top = 196
  Action = MainForm.agWorkerClass
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select  *, UserInfo(ID_AssertUser) as AssertUser, WorkClassInfo(' +
        'ID_WorkClass) as WCInfo'
      'from  WorkerClass'
      'where (Deleted = :D or :D = 2) and (Active = :A or :A = 2)'
      'order by  WCInfo, Priority, Name')
    Params = <
      item
