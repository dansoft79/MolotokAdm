object GWorkRestDayForm: TGWorkRestDayForm
  Left = 331
  Top = 196
  Action = MainForm.agWorkRestDay
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewWorkerInfo: TcxGridDBColumn
      ...
      object TableViewDTInfo: TcxGridDBColumn
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
      'select  *, '
        ...
        '  WorkRestDayTypeInfo(DateType) as DTInfo, UserInfo(ID_AssertUse' +
        'r) as AssertUser, WorkerInfo(ID_Worker) as WorkerInfo'
      'from  WorkRestDay'
      'where '
      '  ID_Worker = :IDW and '
      '  (Deleted = :D or :D = 2) and (Active = :A or :A = 2)'
      'order by WorkerInfo, FromDate')
    Params = <
      item
        DataType = ftUnknown
        Name = 'IDW'
    ...
    object QueryDateType: TSmallintField
      FieldName = 'DateType'
    end
    ...
    object QueryWorkTime: TWideStringField
      DisplayLabel = #1056#1072#1073#1086#1095#1077#1077' '#1074#1088#1077#1084#1103
      FieldName = 'WorkTime'
      Size = 44
    end
    object QueryWorkerInfo: TWideStringField
