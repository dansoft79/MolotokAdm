object GAddressLimitForm: TGAddressLimitForm
  Left = 331
  Top = 196
  Action = MainForm.agAddressLimit
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewAddressTypeInfo: TcxGridDBColumn
        DataBinding.FieldName = 'AddressTypeInfo'
        Width = 150
      end
      object TableViewAddressText: TcxGridDBColumn
        DataBinding.FieldName = 'AddressText'
        Width = 300
      end
      object TableViewAddressName: TcxGridDBColumn
  ...
  object ComponentPrinter: TdxComponentPrinter
    ...
    object ComponentPrinterLink1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 44712.690912592600000000
      PixelsPerInch = 96
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
      'select *,'
      '  AddressTypeLimitInfo(AddressType) as AddressTypeInfo'
      'from AddressLimit'
      'order by AddressTypeInfo, AddressText')
    Params = <>
    Left = 56
    Top = 176
    ...
    object QueryAddressType: TSmallintField
      FieldName = 'AddressType'
    end
    object QueryAddressText: TWideStringField
      DisplayLabel = #1040#1076#1088#1077#1089
      FieldName = 'AddressText'
      Size = 400
    end
    object QueryAddressTypeInfo: TWideStringField
      DisplayLabel = #1058#1080#1087' '#1072#1076#1088#1077#1089#1072
      FieldName = 'AddressTypeInfo'
      ReadOnly = True
      Size = 80
    end
    object QueryAddressName: TWideStringField
