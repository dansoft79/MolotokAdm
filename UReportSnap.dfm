object ReportSnapForm: TReportSnapForm
  Left = 495
  Top = 267
  Action = MainForm.arReportSnap
  ...
  object gbReport: TcxGroupBox
    ...
    object GridReport: TcxGrid
      ...
      object TableViewReport: TcxGridDBTableView
        ...
        OptionsView.GroupByBox = False
        OptionsView.Indicator = True
        object TableViewReportType: TcxGridDBColumn
          DataBinding.FieldName = 'Type'
          Width = 150
        end
        object TableViewReportName: TcxGridDBColumn
          DataBinding.FieldName = 'Name'
          Width = 466
        end
      end
  ...
  object Query: TZQuery
    Connection = Datas.ZConnection
    SQL.Strings = (
      'select R.Type, R.Name, RS.*'
      'from ReportForm R, ReportSnap RS'
      'where '
      '  RS.ID_User = :ID and'
      '  R.ID = RS.ID_ReportForm and'
      '  R.Deleted = 0'
      'order by Type, Name')
    Params = <
      item
    ...
    object QueryID_ReportForm: TSmallintField
      FieldName = 'ID_ReportForm'
      Required = True
    end
  end
  object Table: TZQuery
    ...
    object TableID_ReportForm: TSmallintField
      FieldName = 'ID_ReportForm'
      Required = True
    end
