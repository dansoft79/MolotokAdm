object WorkTypeSynonymForm: TWorkTypeSynonymForm
  Left = 331
  Top = 196
  Action = MainForm.aaWorkTypeSynonym
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select  WTS.*, UserInfo(WTS.ID_AssertUser) as AssertUser, WT.Nam' +
        'e as WTInfo, WorkClassInfo(WT.ID_WorkClass) as WCInfo'
      'from  WorkTypeSynonym WTS, WorkType WT'
      'where '
      
        '  (WTS.Deleted = :D or :D = 2) and (WTS.Active = :A or :A = 2) a' +
        'nd'
      '  WT.ID = WTS.ID_WorkType'
      'order by  WCInfo, WTInfo, Name')
    Params = <
      item
    ...
    object QueryName: TWideStringField
      DisplayLabel = #1057#1080#1085#1086#1085#1080#1084
      DisplayWidth = 300
      FieldName = 'Name'
      Size = 300
    end
  ...
  object qExists: TZQuery
    ...
    SQL.Strings = (
      'select ID'
      'from WorkTypeSynonym'
      'where Name = :N and ID_WorkType = :W and ID <> :IDE'
      'limit 1')
    Params = <
      item
        DataType = ftUnknown
