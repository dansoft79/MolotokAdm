object ClientRequestForm: TClientRequestForm
  Left = 331
  Top = 196
  Action = MainForm.aaClientRequest
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewProcessed: TcxGridDBColumn
      ...
      object TableViewWTInfo: TcxGridDBColumn
      ...
      object TableViewClientSession: TcxGridDBColumn
        DataBinding.FieldName = 'ClientSession'
        Width = 150
      end
    end
  ...
  object Query: TZQuery
    ...
    SQL.Strings = (
        ...
        'select  CR.*, UserInfo(CR.ID_AssertUser) as AssertUser, WT.Name ' +
        'as WTInfo, WorkClassInfo(WT.ID_WorkClass) as WCInfo'
      'from  ClientRequest CR, WorkType WT'
      'where '
      '  (CR.Deleted = :D or :D = 2) and (CR.Active = :A or :A = 2) and'
      '  WT.ID = CR.ID_WorkType'
      'order by  WCInfo, WTInfo, RequestText')
    Params = <
      item
    ...
    object QueryProcessed: TSmallintField
      DisplayLabel = #1054#1073#1088#1072#1073#1086#1090#1072#1085#1086
      FieldName = 'Processed'
    end
    object QueryID_WorkType: TSmallintField
      FieldName = 'ID_WorkType'
    end
    object QueryClientSession: TWideStringField
      DisplayLabel = #1057#1077#1089#1089#1080#1103
      FieldName = 'ClientSession'
      Size = 100
    end
  ...
  object qExists: TZQuery
    ...
    SQL.Strings = (
      'select ID'
      'from ClientRequest'
      'where REquestText = :N and ID_WorkType = :W and ID <> :IDE'
      'limit 1')
    Params = <
      item
        DataType = ftUnknown
